...
const FiltersForm = forwardRef<FiltersRef, Props>((props, ref) => {
  ...
  const handleSubmit = (values: FilterValues) => {
    const { startDateCreate, endDateCreate, startDatePayment, endDatePayment, ...rest } = values;
    ...
    >
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6} md={4} lg={2.4}>
          <ProDateRange label={t('Ngày tạo')} from='startDateCreate' to='endDateCreate' />
        </Grid>
        <Grid item xs={12} sm={6} md={4} lg={2.4}>
          <ProDateRange label={t('Hạn thanh toán')} from='startDatePayment' to='endDatePayment' />
        </Grid>
        <Grid item xs={12} sm={6} md={3} lg={1.5}>
          <ProFormSelect
            name='typeDocument'
        ...
        <Grid item xs={12} sm={6} md={3} lg={2}>
          <ProFormFilterAction onSubmit={onSubmit} onClear={onClear} onExpanded={onExpended} />
        </Grid>
      </Grid>
