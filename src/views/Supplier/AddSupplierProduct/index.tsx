...
const AddSupplierTable = () => {
  ...
  const handleChangeRadio = (event: React.ChangeEvent<HTMLInputElement>, value: string) => {
    setRadioValue(value);
  };
          ...
          <Paper sx={{ p: 2, mt: 1 }}>
            ...
            <FormControl>
              <RadioGroup row value={radioValue} onChange={handleChangeRadio}>
                <FormControlLabel value='1' control={<Radio />} label='Tiếp tục thêm' />
                <FormControlLabel value='2' control={<Radio />} label='Hiện danh sách' />
              </RadioGroup>
            </FormControl>
          </Paper>
        </ProFormContent>
