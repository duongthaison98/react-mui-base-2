      ...
      columnHelper.group({
        ...
        columns: [
          ...
          columnHelper.accessor('SP', {
            ...
            cell: (context) => Math.round(Math.random() * 100),
            meta: {
              title: HEAD_CELLS.SP,
            },
          }),
          ...
          columnHelper.accessor('count', {
            ...
            cell: (context) => Math.round(Math.random() * 5000),
            meta: {
          ...
          columnHelper.accessor('creator', {
            ...
            cell: (context) => (
              <Typography variant="subtitle2">
                Nguyễn Xuân Anh
                <Typography variant="subtitle1"> 19:36 09/02</Typography>
              </Typography>
            ),
            meta: {
