...
const AddSupplierProduct = Loadable(lazy(() => import('@/views/Supplier/AddSupplierProduct')));
const CreateProducts = Loadable(lazy(() => import('@/views/Products/CreateProducts/index')));

const ProductInfo = Loadable(lazy(() => import('@/views/Products/ProductInfo')));
const SetPriceProduct = Loadable(lazy(() => import('@/views/Products/SetPriceList')));
