...
const DailyIncome = Loadable(lazy(() => import('@/views/Report/AccountingInReportDaily')));
const AddCashTable = Loadable(lazy(() => import('@/views/Accounting/AddCash')));
const AddCashBookTable = Loadable(lazy(() => import('@/views/Accounting/CashBooks')));
const Accounting = Loadable(lazy(() => import('@/views/Accounting/Accounts')));
const AccountingDebtCustomer = Loadable(lazy(() => import('@/views/Accounting/Debt/Customer')));
const AccountingDebtSupplier = Loadable(lazy(() => import('@/views/Accounting/Debt/Supplier')));
const SumaryCashByStore = Loadable(
  lazy(() => import('@/views/Report/AccountingInReport/SumaryCashByStore')),
);
const TransactionIndex = Loadable(lazy(() => import('@/views/Accounting/TransactionIndex')));
const TransactionLog = Loadable(lazy(() => import('@/views/Accounting/TransactionLog')));
const TransactionCreate = Loadable(lazy(() => import('@/views/Accounting/TransactionCreate')));
