...
const Import = Loadable(lazy(() => import('@/views/ImportExportWarehouse/Bill/ImportBill')));
const Export = Loadable(lazy(() => import('@/views/ImportExportWarehouse/Bill/ExportBill')));
const EditOther = Loadable(lazy(() => import('@/views/ImportExportWarehouse/Bill/EditOther')));
const EditImex = Loadable(
  lazy(() => import('@/views/ImportExportWarehouse/ImexProducts/EditImexProducts')),
);
...
const AddOrderSlip = Loadable(lazy(() => import('@/views/Inventory/OrderSlip/AddOrderSlip')));
